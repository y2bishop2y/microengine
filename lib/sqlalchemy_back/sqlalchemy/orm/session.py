...
from lib.sqlalchemy import util, engine, exc as sa_exc
from lib.sqlalchemy.sql import util as sql_util, expression
from lib.sqlalchemy.orm import (
    SessionExtension, attributes, exc, query, util as mapperutil
    )
from lib.sqlalchemy.orm.util import object_mapper as _object_mapper
from lib.sqlalchemy.orm.util import class_mapper as _class_mapper
from lib.sqlalchemy.orm.util import (
    _class_to_mapper, _state_mapper,
    )
from lib.sqlalchemy.orm.mapper import Mapper, _none_set
from lib.sqlalchemy.orm.unitofwork import UOWTransaction
from lib.sqlalchemy.orm import identity
from lib.sqlalchemy import event
from lib.sqlalchemy.orm.events import SessionEvents
...
class Session(object):
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        if isinstance(clause, lib.sqlalchemy.sql.expression.ClauseElement) and clause.bind:
            return clause.bind
