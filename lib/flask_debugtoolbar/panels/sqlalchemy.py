...
try:
    from lib.flask.ext.sqlalchemy import get_debug_queries, SQLAlchemy
except ImportError:
...
from lib.flask import request, current_app, abort, json_available, g
from lib.flask.helpers import json
from lib.flask_debugtoolbar import module
from lib.flask_debugtoolbar.panels import DebugPanel
from lib.flask_debugtoolbar.utils import format_fname, format_sql
