...
"""
from lib.flask_cache import backends
...
from lib.werkzeug import import_string
from lib.flask import request, current_app
...
class Cache(object):
    ...
    def init_app(self, app, config=None):
        ...
        if self.with_jinja2_ext:
            from .lib.flask_cache.jinja2ext import CacheExtension, JINJA_CACHE_ATTR_NAME
