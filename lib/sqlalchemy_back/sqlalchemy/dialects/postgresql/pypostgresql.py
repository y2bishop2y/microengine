...
"""
from lib.sqlalchemy import util, processors
from lib.sqlalchemy.dialects.postgresql.base import PGDialect, PGExecutionContext
...
class PGDialect_pypostgresql(PGDialect):
    ...
    @classmethod
    def dbapi(cls):
        from lib.sqlalchemy.dialects.postgresql.driver import dbapi20
        return dbapi20
