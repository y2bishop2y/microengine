...
from lib.werkzeug._internal import _patch_wrapper
...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    :param collapse_http_schemes: if set to `False` the algorithm does
                                  ...
                                  resource.
    """
    from lib.werkzeug.urls import uri_to_iri
...
class LimitedStream(object):
    ...
    def on_exhausted(self):
        ...
        if self.silent:
            return ''
        from lib.werkzeug.exceptions import BadRequest
    ...
    def on_disconnect(self):
        ...
        """
        from lib.werkzeug.exceptions import ClientDisconnected
